...
def predict():
    ...
    dataDate = request.args.get('Date')
    lon = request.args.get('lon')
    lat = request.args.get('lat')

    prediction = clf.predict([[dataDate,lon,lat]]) #prediction of model
    probs = clf.predict_proba([[dataDate,lon,lat]]).tolist() #probability of predictions
